...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                continue # 안쪽 for 문 조건이 맞지 않으면 continue. 바같 for 문 계속 수행
            break # 안쪽 for 문에서 break 를 만나면 여기로 진입 가능. 2중 for 문을 한번 탈출
    ...
    # 모든 공이 없앤 경우 게임 종료 (성공)
    if len(balls) == 0:
        game_result = 'Mission Conplete'
        running = False
